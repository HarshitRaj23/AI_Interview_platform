  ...
  useEffect(() => {
    ...
    const onMessage = (message: Message) => {
      if (message.type === "transcript" && message.transcriptType === "final") {
        setMessages((prev) => [...prev, { role: message.role || "assistant", content: message.transcript || "" }]);
      }
    };
      ...
      <div className="call-view">
        ...
        <div className="card-border">
          <div className="card-content">
            <Image src="/hrajimg.jpg" alt="profile-image" width={539} height={539} className="rounded-full object-cover size-[120px]" />
            <h3>{userName}</h3>
          </div>
        </div>
      </div>
