        ...
        <div className='card-border w-[360px] max-sm:w-full min-h-96'>
            <div className='card-interview'>
                <div>
                    ...
                    <Image src={getRandomInterviewCover()} alt="interview cover" width={90} height={90} className='rounded-full' />
                    ...
                    <p className='line-clamp-2 mt-5'>
                        {feedback?.finalAssessment || "No you haven't taken the interview  yet. take it now to improve your skills."}
                    </p>
                </div>
